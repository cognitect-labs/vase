(defproject my-vase-app "0.0.1-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "my-vase-app.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.4.2-SNAPSHOT"]]}
             :uberjar {:aot [my-vase-app.server]}}
  :main ^{:skip-aot true} my-vase-app.server)
