(defproject vasebi "0.9.3-SNAPSHOT"
  ...
  :profiles {:dev {:aliases {"run-dev" ["trampoline" "run" "-m" "vasebi.server/run-dev"]}
                   :dependencies [[io.pedestal/pedestal.service-tools "0.5.5"]]}
             :uberjar {:aot [vasebi.server]
                       :main vasebi.server}}
  :main ^{:skip-aot true} vasebi.server)
